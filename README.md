...
To run the benchmark you must first install the MobilityDB extension in your system. You should install the latest version of MobilityDB in the `develop` branch
```
git clone --branch develop https://github.com/MobilityDB/MobilityDB
```
We refer to the [MobilityDB](https://github.com/MobilityDB/MobilityDB) documentation for doing this.
...
# The following loads the data for the scale factor 1.
# You can use the argument 10 or 100 for the other scale factors
